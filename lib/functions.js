...
var sortDocs = function(docs, query) {
	console.log('sortDocs: query ',query);
	...
	if (query.path == 'authors') {
		if (!(sortField == 'firstName' || sortField == 'lastName' || sortField == 'posts' || sortField == 'id')) {
			console.log("invalid sort field")
			callback(500, "invalid sort field")
			return
		}
	} else {
		if (!(sortField == 'view' || sortField == 'author' || sortField == 'title' || sortField == 'id')) {
			console.log("invalid sort field")
			callback(500, "invalid sort field")
			return
		}
